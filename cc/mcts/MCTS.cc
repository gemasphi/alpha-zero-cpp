...
ArrayXf MCTS::simulate(std::shared_ptr<GameState> root, NNWrapper& model, float temp, int n_simulations){
...
NN::Output MCTS::maybeEvaluate(NNWrapper& model, std::shared_ptr<GameState> leaf){
	std::stringstream ss;
